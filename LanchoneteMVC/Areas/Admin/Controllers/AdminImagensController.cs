...
namespace LanchoneteMVC.Areas.Admin.Controllers
{
    ...
    public class AdminImagensController : Controller
    {
        ...
        public async Task<IActionResult> UploadFiles(List<IFormFile> files)
        {
            ...
            if (files.Count >= 10)
            {
                ViewData["Erro"] = "Error: Limite de arquivos é somente 10";
                return View(ViewData);
            }
            ...
            //Obtem o caminho completo onde se armazena os arquivos
            ...
            ViewData["Resultado"] = $"{files.Count} arquivos foram enviado ao servidor, " + $"com tamanho total de: {size} bytes";
        ...
        {
            //Caminho completo da minha pasta para deletar o arquivo
